...
export async function getIntegrations(): Promise<Integration[]> {
  ...
  return [
    {
      id: "rmi",
      name: "מכרזים, תכנון והתחדשות עירונית",
      source: "data.gov.il (CKAN)",
      state: ckan.ok ? "live" : "off",
      powers: "דף מכרזים, לוח בקרה, מפה ארצית, חיתום",
      detail: ckan.ok
        ? "מחובר חי — שלושה דאטהסטים רשמיים: מכרזי רמ״י (1,539), מלאי תכנוני/תב״ע (1,112) ומתחמי התחדשות עירונית (940). מתעדכן אוטומטית."
        : "כרגע לא נגיש.",
      url: "https://data.gov.il",
    },
    {
      id: "parcels",
      name: "גבולות גוש-חלקה ומיקום",
      source: "GovMap WFS · למ״ס",
      state: "live",
      powers: "מפת הפרויקט, הדמיית מסה תלת-ממדית",
      detail:
        "גיאומטריית חלקה אמיתית נשלפת לכל פרויקט עם גוש/חלקה (GovMap, EPSG:3857→WGS84). למכרזים אין מזהה חלקה בנתונים הפתוחים — מיקומם נגזר ממרכז היישוב (1,319 יישובים, למ״ס, ITM→WGS84), וההדמיה התלת-ממדית מסומנת כ״הדמיית נפח להמחשה״ עד שמצורף גוש/חלקה.",
